...
#ifndef H_FOREXCOIN_SCRIPT
#define H_FOREXCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CForexcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Forexcoin always counted CHECKMULTISIGs
