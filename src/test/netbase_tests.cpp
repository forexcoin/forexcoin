...
{
    BOOST_CHECK(TestSplitHost("www.forexcoin.org", "www.forexcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.forexcoin.org]", "www.forexcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.forexcoin.org:80", "www.forexcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.forexcoin.org]:80", "www.forexcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:9370", "127.0.0.1", 9370));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:9370", "127.0.0.1", 9370));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:9370", "::ffff:127.0.0.1", 9370));
    BOOST_CHECK(TestSplitHost("[::]:9370", "::", 9370));
    BOOST_CHECK(TestSplitHost("::9370", "::9370", -1));
    BOOST_CHECK(TestSplitHost(":9370", "", 9370));
    BOOST_CHECK(TestSplitHost("[]:9370", "", 9370));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:9370", "127.0.0.1:9370"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:9370", "[::]:9370"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
