...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Forexcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"v3globalforexcoin.com", "v3dnsseed.globalforexcoin.com"},   
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"v3globalforexcoin.com", "v3testnet-seed.globalforexcoin.com"},   
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Forexcoin is probably already running."), addrBind.ToString().c_str());
        else
