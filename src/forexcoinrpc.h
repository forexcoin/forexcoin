...
#ifndef _FOREXCOINRPC_H_
#define _FOREXCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Forexcoin is not connected
...
/**
 * Forexcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
